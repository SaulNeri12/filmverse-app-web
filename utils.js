...
export function generarEstrellas(calificacion) {
...
export function mostrarNoResultados(consulta) {
    const contenedor = document.querySelector('.contenedor-resultados');
    contenedor.innerHTML = `
...
export function getGeneroNombre(genreId) {
    const generos = {
        28: 'Acción',
        12: 'Aventura',
        16: 'Animación',
...
export async function buscarPelicula(consulta, pagina = 1) {
    try {
...
export const buscarPeliculasPopulares = async () => {
